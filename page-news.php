...
<section class="relative h-[400px] md:h-[501px] flex justify-center items-center">
	<div class="absolute w-full h-[110%] left-0 -top-[10%]" data-scroll data-scroll-speed="2">
		<img
			...
			src="<?php echo get_template_directory_uri(); ?>/images/bg-news.jpg"
...
<section class="bg-beige py-24 md:py-32">
				...
				<article class="border-t border-[#CBAF8A]/40 py-12 first:border-t-0 first:pt-0">
					<div class="grid md:grid-cols-[minmax(0,320px)_minmax(0,1fr)] gap-8 md:gap-12 items-start">
						<div class="w-full">
							...
							<?php else : ?>
								<a href="<?php the_permalink(); ?>" class="block overflow-hidden rounded-lg bg-primary/5 h-full min-h-[220px] flex items-center justify-center">
						...
						<div class="flex flex-col justify-between h-full">
							...
							<div class="mt-6">
								<a href="<?php the_permalink(); ?>" class="inline-flex items-center body text-terracota hover:text-primary transition-colors">
									Read more
								</a>
							</div>
						</div>
...
<section class="bg-beige relative pb-24 md:pb-32">
	<div class="absolute w-full h-full left-0 top-0 opacity-40 pointer-events-none">
		<img
			class="w-full h-full object-cover object-top"
			src="<?php echo get_template_directory_uri(); ?>/images/bg-promotions.jpg"
