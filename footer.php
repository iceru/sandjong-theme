...
<footer class="bg-primary-2 text-beige relative z-20 snap-start">
        ...
        <div class="w-full">
            <div class="hidden md:flex flex-wrap md:flex-nowrap space-y-12 md:space-y-0 md:space-x-14">
                ...
                <div>
                    ...
                    <div>
                        <ul class="space-y-5">
                            <li><a href="tel:+622139521229" class="flex space-x-2 !no-underline items-center">
                            ...
                            <li><a href="https://wa.me/6282130376088" target="_blank"
                                    class="flex space-x-2 !no-underline items-center">
                                    <img class="w-4 h-4"
